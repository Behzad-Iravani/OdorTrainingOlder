% -*- coding: 'UTF-8' -*-
function totalvolume = estimate_total_volume(obj)
...
if ~exist('C:\Projects\Git\+Analysis\@POSTPROCVBM\totalvolumes.tsv','file')
    %%---------------------------------------------------------------%%
    ...
    matlabbatch{1}.spm.util.tvol.outf = 'C:\Projects\Git\+Analysis\@POSTPROCVBM\totalvolumes.tsv';
    spm_jobman('run', matlabbatch);
end
totalvolume = readtable('C:\Projects\Git\+Analysis\@POSTPROCVBM\totalvolumes.tsv', 'FileType','text');
totalvolume.Properties.VariableNames = {'File', 'Gray', 'White', 'CSF'}; 
end
